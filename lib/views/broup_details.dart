...
class BroupDetails extends StatefulWidget {
  ...
  BroupDetails({required Key key, required this.chat}) : super(key: key);
...
class _BroupDetailsState extends State<BroupDetails> {
  ...
  void initBroupDetailsSockets() {
    socketServices.socket.on('message_event_change_broup_details_failed',
        (data) {
      broupDetailUpdateFailed();
    });
    socketServices.socket.on('message_event_change_broup_alias_failed', (data) {
      broupAliasUpdateFailed();
    });
    socketServices.socket.on('message_event_change_broup_colour_failed',
        (data) {
      broupColourUpdateFailed();
    });
    socketServices.socket.on('message_event_change_broup_add_admin_failed',
        (data) {
      broupAddAdminFailed();
    });
    socketServices.socket.on('message_event_change_broup_dismiss_admin_success',
        (data) {
      broupDismissAdminSuccess(data);
    });
    socketServices.socket.on('message_event_change_broup_dismiss_admin_failed',
        (data) {
      broupDismissAdminFailed();
    });
    socketServices.socket.on('message_event_change_broup_remove_bro_failed',
        (data) {
  ...
  void dispose() {
    ...
    socketServices.socket
        .off('message_event_change_broup_dismiss_admin_success');
    socketServices.socket
        .off('message_event_change_broup_dismiss_admin_failed');
